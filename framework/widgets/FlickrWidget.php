...
class FlickrWidget extends WP_Widget {
  ...
  {
    $widget_ops = array('classname' => 'flickr', 'description' => __('The most recent photos from flickr.', 'salamander'));
    $control_ops = array('id_base' => 'flickr-widget');
    $this->WP_Widget('flickr-widget', 'Salamander: Flickr', $widget_ops, $control_ops);
  }
  ...
  {
    $defaults = array(
      'title' => __('Photos from Flickr', 'salamander'),
      'screen_name' => '',
      'number' => 6,
      'api' => 'c9d2c2fda03a2ff487cb4769dc0781ea',
    );
