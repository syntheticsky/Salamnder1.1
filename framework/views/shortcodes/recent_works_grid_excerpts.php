<div class="portfolio clearfix portfolio-<?php print $columns_words; ?>-text portfolio-<?php print $columns_words; ?>" data-columns="<?php print $columns_words; ?>">
...
<?php
		...
		<li><a data-filter=".<?php print $portfolio_cat->slug; ?>" href="#"><?php print $portfolio_cat->name; ?></a></li>
	<?php endif;
			else: ?>
		<li><a data-filter=".<?php print $portfolio_cat->slug; ?>" href="#"><?php print $portfolio_cat->name; ?></a></li>
<?php	endif;
...
<?php if ( has_post_thumbnail() ): ?>
	...
	<?php	endif;
			...
			<div class="portfolio-content">
				<h2><a href="<?php print $permalink; ?>"><?php print get_the_title(); ?></a></h2>
				<h4><?php print get_the_term_list( get_the_ID(), 'portfolio_category', '', ', ', '' ); ?></h4>
			<?php $excerpt_length = $excerpt_words;
						$stripped_content = strip_shortcodes( tf_content( $excerpt_length, Salamander::getData( 'strip_html_excerpt' ) ) );
						print $stripped_content;
				if ( $columns == 1 ): ?>
				<div class="buttons">
					<a href="<?php print $permalink; ?>" class="green button small"><?php _e( 'Learn More', 'Salamander' ); ?></a>
		<?php if ( get_post_meta(get_the_ID(), 'sl_meta_project_url', true ) ): ?>
					<a href="<?php print get_post_meta( get_the_ID(), 'sl_meta_project_url', true ); ?>" class="green button small"><?php _e( 'View Project', 'Salamander' ); ?></a>
		<?php endif; ?>
				</div>
	<?php endif; ?>
			</div>
